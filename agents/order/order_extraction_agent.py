...
#
#
# def looks_like_road(value: str) -> bool:
#     value = value.strip()
#
#     # Explicit Singapore expressway abbreviations
#     if value.upper() in SINGAPORE_EXPRESSWAYS:
#         return True
#
#     # Named road suffix
...
#     return False
#
# from models.order.order_constraint import ConstraintType, OrderConstraint
#
#
# def normalize_constraint(constraint: OrderConstraint) -> OrderConstraint:
#     value = str(constraint.value).strip()
#     print(value)
#
#     if looks_like_road(value):
#         if constraint.type == ConstraintType.AVOID_AREA:
#             constraint.type = ConstraintType.AVOID_ROAD
#
#         elif constraint.type == ConstraintType.REQUIRED_AREA:
#             constraint.type = ConstraintType.REQUIRED_ROAD
#
#     return constraint
#
...
#         self.llm_engine = ChatOpenAI(model="gpt-5.4")
#         # Change this line in your __init__:
#         self.llm = self.llm_engine.with_structured_output(IncomingOrder, method="json_schema", strict=True)
#
...
#         ]
#
#         print("ORder after constraint normalization: ", result)
#
#         if isinstance(result, dict):
#             result = IncomingOrder(result)
#
#         if not isinstance(result, IncomingOrder):
